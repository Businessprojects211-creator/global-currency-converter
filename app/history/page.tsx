...
export const metadata = { title: "Rate History | Global Currency Converter", description: "Explore historical provider reference data for selected currency pairs.", alternates: { canonical: "/history" } };
