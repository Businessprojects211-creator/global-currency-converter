...
export default function Converter() {
  ...
  async function copy() { if (result === null) return; await navigator.clipboard.writeText(`${amount} ${from} = ${money.format(result)} ${to}`); setCopied(true); setTimeout(() => setCopied(false), 1800); }
