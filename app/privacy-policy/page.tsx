...
export default function Privacy() {
	return <main className="legal"><a className="brand" href="/">↗ Global<span>Convert</span></a><article>
		<p className="eyebrow">PRIVACY POLICY</p><h1>Privacy Policy</h1><p>Effective date: September 5, 2026</p><p>Welcome to Global Currency Converter. This policy explains how {operator} may collect, use, store, and share information when you use our website.</p>
		...
		<h2>Your choices and rights</h2><p>Depending on your location and applicable law, you may request access, correction, deletion, restriction, objection, or information about our practices, and withdraw consent where processing is based on consent. Contact <a href={`mailto:${email}`}>{email}</a>; we may verify your identity.</p>
		<h2>Children, external links, and changes</h2><p>We do not knowingly collect children’s personal information in violation of applicable law. External websites have their own policies. We may update this policy and will revise the effective date when appropriate.</p>
